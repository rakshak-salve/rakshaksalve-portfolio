...
* **Lazy Loading & Suspense**: Implemented code-splitting for heavy components like **CodingHeatmaps** and **GithubStats** to ensure optimal initial load times.
* **Custom Hooks**: Developed `useDecodeText` to provide high-end, interactive UI elements for the **Hero** section without sacrificing performance.
...
* **Build Tool**: **Vite v7.3.1** (Optimized for development speed and production performance).
* **Styling**: **Tailwind CSS** (Utility-first architecture).
* **Visual Proof**: Integration with custom SVG APIs for real-time **LeetCode** and **CodeChef** performance metrics.
...
Java Full Stack Specialist: Completed intensive training at VibrantMinds Technologies.
...
Bash
git clone [https://github.com/rakshak-salve/rakshaksalve-portfolio.git](https://github.com/rakshak-salve/rakshaksalve-portfolio.git)
...
© 2026 Rakshak Salve. Built for Impact.
